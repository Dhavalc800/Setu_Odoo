...
class quickCreateController(Controller):
    ...
    @route(['/theme/get/quick_create'], type='json', auth='public', csrf=False)
    ...
    @route(['/theme/quick_create/add'], type='json', auth='public', csrf=False)
    ...
    @route(['/theme/quick_create/delete'], type='json', auth='public', csrf=False)
    ...
    @route(['/theme/quick_create/update'], type='json', auth='public', csrf=False)
