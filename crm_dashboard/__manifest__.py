...
#############################################################################
{
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'crm_dashboard/static/src/js/highcharts.js',
            'crm_dashboard/static/src/js/Chart.bundle.js',
            'crm_dashboard/static/src/js/funnel.js',
            'crm_dashboard/static/src/js/d3.min.js',
            'crm_dashboard/static/src/js/material-gauge.js',
            'crm_dashboard/static/src/js/columnHeatmap.min.js',
            'crm_dashboard/static/src/js/columnHeatmap.js',
