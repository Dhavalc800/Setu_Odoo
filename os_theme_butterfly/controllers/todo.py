...
class TodoController(Controller):
    ...
    @route(['/theme/todo/save'], type='json', auth='public', csrf=False)
    ...
    @route(['/theme/get/todo'], type='json', auth='public', csrf=False)
    ...
    @route(['/theme/todo/toggle/done'], type='json', auth='public', csrf=False)
    ...
    @route(['/theme/todo/delete'], type='json', auth='public', csrf=False)
    ...
    @route(['/theme/todo/edit'], type='json', auth='public', csrf=False)
