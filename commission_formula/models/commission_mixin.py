...
class CommissionLineMixin(models.AbstractModel):
    ...
    def _get_commission_amount(self, commission, subtotal, product, quantity,line):
        ...
        return super()._get_commission_amount(commission, subtotal, product, quantity, line)
